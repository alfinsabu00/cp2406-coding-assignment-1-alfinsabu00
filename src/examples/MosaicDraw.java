...
/**
 * examples.MosaicDraw is a JavaFX Application whose scene includes a examples.MosaicCanvas and a
 ...
 *
 * Note that this class depends on examples.MosaicCanvas.java.
 */
public class MosaicDraw extends Application {
    ...
    private examples.MosaicCanvas mosaic;     // The panel where the drawing takes place.
    ...
    public void start(Stage stage) {
        ...
        mosaic = new examples.MosaicCanvas(ROWS, COLUMNS, SQUARE_SIZE, SQUARE_SIZE);
     ...
     * drawing that is done on the examples.MosaicCanvas.
     */
